    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                    <a href="#"><i class="fa fa-cubes"></i> <span>материалы</span>
                        <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
                    </a>
                    <ul class="treeview-menu">
                        ...
                        <li><a href="<?= ADMIN ?>/material/add">Добавить материал</a></li>
                    </ul>
                </li>
...
<i class="fa fa-angle-left pull-right"></i>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2019 <a href="https://adminlte.io">Tovpeko Studio</a>.</strong> All rights
        reserved.
    </footer>
