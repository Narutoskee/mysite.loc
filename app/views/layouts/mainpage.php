...
<div class="logo">
<!--    site title-->
    <a href="<?=PATH;?>"><h1>Название Сайта</h1></a>
</div>
<!--start-logo-->
<!--bottom-header-->
    ...
    <div class="container">
        <div class="infor-top">
            ...
            <div class="col-md-4 infor-left">
                <h3>Ссылки</h3>
                <ul>
                    <li><a href="/category/novosti"><p>Новости</p></a></li>
...
<!--            </div>-->
            <div class="col-md-4 infor-left">
                ...
                <h4>Товпеко Александра и Ко,
                    <span>Lorem ipsum dolor,</span>
                    Glasglow Dr 40 Fe 72.</h4>
                <h5>+375 29 123 45 67</h5>
                <p><a href="mailto:tovpeko@sss.by">tovpeko@sss.by</a></p>
            </div>
            <div class="clearfix"></div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="footer-top">
            <div class="col-md-6 footer-left">
                <form>
                    <input type="text" value="Напишите вашу почту" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Enter Your Email';}">
                    <input type="submit" value="Подписаться">
                </form>
            </div>
            <div class="col-md-6 footer-right">
                <p>© 2020. All Rights Reserved | Design by  Topvpeko</p>
            </div>
            <div class="clearfix"></div>
        </div>
    </div>
