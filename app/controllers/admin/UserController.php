...
class UserController extends AppController {
    ...
    public function editAction(){
        ...
        $orders = \R::getAll("SELECT `order`.`id`, `order`.`user_id`, `order`.`status`, `order`.`date`, `order`.`update_at`, `order`.`currency`, ROUND(SUM(`order_material`.`price`), 2) AS `sum` FROM `order`
